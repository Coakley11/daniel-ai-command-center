...
Last verified: 2026-05-31 (build 2026-05-31-v4 on branch `dev`)
...
| AI Homeroom | DEV | https://applied-mathematical-intelligence-8l8bqrzpp6fghaj7xuig53.streamlit.app |
| AI Future Simulator | MAIN | https://future-lens-ai-transition-simulator-8qfgube5tezjjaxruppnuo.streamlit.app |
...
The homepage footer shows `build 2026-05-31-v4`. If you see an older build or `share.streamlit.io` links, Production has not redeployed yet.
